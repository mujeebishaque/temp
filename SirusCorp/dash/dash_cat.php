		...
		<div class="container">
			<div class="row">
					...
					<div class="move-left">
					  <div class="list-group">
						...
						<div class="list-group" id="myList" role="tablist">
						  ...
						  <a class="list-group-item list-group-item-action active" data-toggle="list" href="dash_cat.php" role="tab">Armed Forces Events</a>
				...
				<div class="col-sm-9 offset-sm-1">
					<h2 class="text-center links" style="color: black;">Categories</h2>
					<hr />
					<br />
					...
					<table class="table table-bordered table-dark">
					  <thead>
					    <tr>
					      <th scope="col">Competitions of Armed Forces</th>
					    </tr>
					  </thead>
					  <tbody>
					    <tr>
					      <th scope="row">
					      	<?php include('primary_function.php'); armed_forces_competition();?>
					      </th>   
					    </tr>
					  </tbody>
					</table>
