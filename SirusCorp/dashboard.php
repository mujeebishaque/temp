...
<!-- carousel here -->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item">
      <img class="d-block img-fluid size" src="images/1.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block img-fluid size" src="images/2.jpg" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block img-fluid size" src="images/3.jpg" alt="Fourth slide">
    </div>
    <div class="carousel-item">
      <img class="d-block img-fluid size" src="images/5.jpg" alt="Fifth slide">
    </div>
			...
			<div class="row">
					...
					<div class="move-left">
					  <div class="list-group">
						...
						<div class="list-group" id="myList" role="tablist">
						  ...
						  <a class="list-group-item list-group-item-action active" data-toggle="list" href="index.php" role="tab"><i class="fa fa-home"></i>Home</a>
				...
				<div class="col-sm-9 offset-sm-1">
					...
					<ul class="list-group list-group-flush">
					  ...
					  <li class="list-group-item">3 - Watch events</li>
