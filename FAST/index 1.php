...
if (isset($_POST["create_user"]))
{
    ...
    echo $user_id = $_POST["user_id"]; echo '<br/>';
    echo $email = $_POST["email"]; echo '<br/>';
    echo $contact = $_POST["contact"]; echo '<br/>';
		...
		<div class="container">
			<div class="row">
				...
				<div class="form-group row">
					  <label for="example-text-input" class="col-2 col-form-label" style="color: white;">Username or Email Id or Contact Number</label>
					  <div class="col-12">
