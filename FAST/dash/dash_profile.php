		...
		<div class="container">
			<div class="row">
					...
					<div class="move-left">
					  <div class="list-group">
						...
						<div class="list-group" id="myList" role="tablist">
						  ...
						  <a class="list-group-item list-group-item-action active" data-toggle="list" href="dash_profile.php" role="tab">Profile</a>
				...
				<div class="col-sm-9 offset-sm-1">
					<h2 class="text-center links" style="color: black;">Your Profile</h2>
					<hr />
					<br />
